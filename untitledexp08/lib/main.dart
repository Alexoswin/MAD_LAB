...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Routing', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700),),backgroundColor: Colors.lightBlue[500],),
                    ...
                    MapOptions(
                      ...
                      children: [
                        TileLayer(
                          ...
                          userAgentPackageName: 'com.example.madexp8aditya',
                        ),
                        PolylineLayer(
